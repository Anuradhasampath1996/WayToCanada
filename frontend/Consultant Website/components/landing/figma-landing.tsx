  ...
  return (
    <div className="figma-landing">
      ...
      <main>
        ...
        <section className="fl-maple fl-section"><div className="fl-container fl-maple-grid"><div className="fl-maple-copy"><Eyebrow>Work smarter with Maple AI</Eyebrow><h2>Your AI assistant for faster, smarter decisions</h2><p>Ask questions, get instant insights and let Maple AI handle the busy work for you.</p><div className="fl-maple-list">{["Summarize client documents", "Find expiring documents and deadlines", "Draft emails and letters", "Get compliance suggestions"].map((item) => <div key={item}><span><Sparkles size={18} /></span>{item}</div>)}</div><RedButton>Meet Maple AI</RedButton></div><div className="fl-maple-art"><Image src={asset("maple-ai.png")} alt="Maple AI support assistant" fill sizes="420px" priority={false} /></div></div></section>
