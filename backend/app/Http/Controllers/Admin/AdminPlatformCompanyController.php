...
class AdminPlatformCompanyController extends Controller
{
    ...
    public function update(Request $request): JsonResponse
    {
        $data = $request->validate([
            ...
            'business_number'              => 'nullable|string|max:64',
            'gst_hst_number'               => 'nullable|string|max:128',
            'qst_number'                   => 'nullable|string|max:64',
            'pst_number'                   => 'nullable|string|max:64',
            'ontario_corporation_number'   => 'nullable|string|max:32',
