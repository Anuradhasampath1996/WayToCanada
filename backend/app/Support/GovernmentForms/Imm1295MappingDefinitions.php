...
final class Imm1295MappingDefinitions
{
    ...
    public static function all(): array
    {
        return [
            ...
            // Phone lives under ContactInformation on Page2 for this version.
            ['applicant.contact.phone', 'form1[0].Page2[0].ContactInformation[0].contact[0].PhoneNumbers[0].Phone[0].ActualNumber[0]', false, 'text'],
