...
Route::middleware('auth:sanctum')->group(function () {
    ...
    Route::get('client/case-assignment', [\App\Http\Controllers\ClientCaseAssignmentController::class, 'show'])->name('client.case-assignment.show');
    Route::post('client/case-assignment/extra-data', [\App\Http\Controllers\ClientCaseAssignmentController::class, 'saveExtraData'])->name('client.case-assignment.extra-data');
    Route::get('client/representative', [\App\Http\Controllers\ClientCaseRepresentativeController::class, 'show'])->name('client.representative.show');
    Route::post('client/representative/sign', [\App\Http\Controllers\ClientCaseRepresentativeController::class, 'sign'])->name('client.representative.sign');
    Route::get('client/final-review', [\App\Http\Controllers\ClientCaseFinalReviewController::class, 'show'])->name('client.final-review.show');
    Route::post('client/final-review/acknowledge', [\App\Http\Controllers\ClientCaseFinalReviewController::class, 'acknowledge'])->name('client.final-review.acknowledge');
    Route::post('client/final-review/sign', [\App\Http\Controllers\ClientCaseFinalReviewController::class, 'sign'])->name('client.final-review.sign');
    Route::get('client/post-submission', [\App\Http\Controllers\ClientCasePostSubmissionController::class, 'show'])->name('client.post-submission.show');
    ...
    Route::prefix('consultant/clients')->name('consultant.clients.')->group(function () {        Route::get('/',                              [ClientController::class, 'index'])->name('index');
        ...
        Route::get('{profile}/case-file/assessment',             [\App\Http\Controllers\ConsultantCaseAssessmentController::class, 'readiness'])->name('case-file.assessment');
        Route::post('{profile}/case-file/consultation/complete',  [\App\Http\Controllers\ConsultantCaseAssessmentController::class, 'completeConsultation'])->name('case-file.consultation.complete');
        Route::post('{profile}/case-file/consultation/skip',      [\App\Http\Controllers\ConsultantCaseAssessmentController::class, 'skipConsultation'])->name('case-file.consultation.skip');
        Route::post('{profile}/case-file/profile-review',         [\App\Http\Controllers\ConsultantCaseAssessmentController::class, 'reviewProfile'])->name('case-file.profile-review');
        Route::post('{profile}/case-file/maple-recommendation',   [\App\Http\Controllers\ConsultantCaseAssessmentController::class, 'recommend'])->name('case-file.maple-recommendation');
        Route::get('{profile}/case-file/requirement-plan',        [\App\Http\Controllers\ConsultantCaseRequirementPlanController::class, 'show'])->name('case-file.requirement-plan');
        Route::get('{profile}/case-file/requirement-plan/preview', [\App\Http\Controllers\ConsultantCaseRequirementPlanController::class, 'preview'])->name('case-file.requirement-plan.preview');
        Route::get('{profile}/case-file/requirement-plan/registry-diff', [\App\Http\Controllers\ConsultantCaseRequirementPlanController::class, 'registryDiff'])->name('case-file.requirement-plan.registry-diff');
        Route::post('{profile}/case-file/requirement-plan/apply-registry-update', [\App\Http\Controllers\ConsultantCaseRequirementPlanController::class, 'applyRegistryUpdate'])->name('case-file.requirement-plan.apply-registry-update');
        Route::post('{profile}/case-file/requirement-plan/confirm-portal', [\App\Http\Controllers\ConsultantCaseRequirementPlanController::class, 'confirmPortal'])->name('case-file.requirement-plan.confirm-portal');
        Route::get('{profile}/case-file/case-history',            [\App\Http\Controllers\ConsultantCaseRequirementPlanController::class, 'history'])->name('case-file.case-history');
        Route::get('{profile}/case-file/assignment',             [\App\Http\Controllers\ConsultantCaseAssignmentController::class, 'show'])->name('case-file.assignment');
        Route::post('{profile}/case-file/extra-data',            [\App\Http\Controllers\ConsultantCaseAssignmentController::class, 'saveExtraData'])->name('case-file.extra-data');
        Route::get('{profile}/case-file/representative',        [\App\Http\Controllers\ConsultantCaseRepresentativeController::class, 'show'])->name('case-file.representative');
        Route::post('{profile}/case-file/representative',       [\App\Http\Controllers\ConsultantCaseRepresentativeController::class, 'transition'])->name('case-file.representative.transition');
        Route::get('{profile}/case-file/final-review',          [\App\Http\Controllers\ConsultantCaseFinalReviewController::class, 'show'])->name('case-file.final-review');
        Route::post('{profile}/case-file/final-review/checklist', [\App\Http\Controllers\ConsultantCaseFinalReviewController::class, 'saveChecklist'])->name('case-file.final-review.checklist');
        Route::post('{profile}/case-file/final-review/ready-for-client', [\App\Http\Controllers\ConsultantCaseFinalReviewController::class, 'markReadyForClient'])->name('case-file.final-review.ready-for-client');
        Route::post('{profile}/case-file/final-review/ready-to-submit', [\App\Http\Controllers\ConsultantCaseFinalReviewController::class, 'markReadyToSubmit'])->name('case-file.final-review.ready-to-submit');
        Route::post('{profile}/case-file/final-review/acknowledge', [\App\Http\Controllers\ConsultantCaseFinalReviewController::class, 'acknowledge'])->name('case-file.final-review.acknowledge');
        Route::post('{profile}/case-file/final-review/sign',     [\App\Http\Controllers\ConsultantCaseFinalReviewController::class, 'sign'])->name('case-file.final-review.sign');
        Route::post('{profile}/case-file/submission',           [\App\Http\Controllers\ConsultantCaseFinalReviewController::class, 'recordSubmission'])->name('case-file.submission');
        Route::get('{profile}/case-file/post-submission',       [\App\Http\Controllers\ConsultantCasePostSubmissionController::class, 'show'])->name('case-file.post-submission');
        Route::post('{profile}/case-file/government-requests',  [\App\Http\Controllers\ConsultantCasePostSubmissionController::class, 'storeRequest'])->name('case-file.government-requests.store');
        Route::post('{profile}/case-file/government-requests/{governmentRequest}/in-progress', [\App\Http\Controllers\ConsultantCasePostSubmissionController::class, 'markRequestInProgress'])->name('case-file.government-requests.in-progress');
        Route::post('{profile}/case-file/government-requests/{governmentRequest}/answered', [\App\Http\Controllers\ConsultantCasePostSubmissionController::class, 'markRequestAnswered'])->name('case-file.government-requests.answered');
        Route::post('{profile}/case-file/decision',             [\App\Http\Controllers\ConsultantCasePostSubmissionController::class, 'recordDecision'])->name('case-file.decision');
        Route::post('{profile}/case-file/closure/checklist',    [\App\Http\Controllers\ConsultantCasePostSubmissionController::class, 'saveClosureChecklist'])->name('case-file.closure.checklist');
        Route::post('{profile}/case-file/closure/close',        [\App\Http\Controllers\ConsultantCasePostSubmissionController::class, 'closeCase'])->name('case-file.closure.close');
    ...
    Route::middleware('role:super-admin,admin')->prefix('admin')->name('admin.')->group(function () {
        ...
        Route::any('academy/{path?}', function () {
            return response()->json(['message' => 'RCIC Academy has been removed from this platform.'], 410);
        })->where('path', '.*');
    });
});
